...
any new record to any table or updating existing data in our db.. 
*/
class QueryBuilder{
    protected $pdo; //think about it like this, it just a copy of pdo opject that we can use it inside our class.
    ...
    */
    ...
    and this line here, its functionality is to construct a sql insert query in a dynamic way.
