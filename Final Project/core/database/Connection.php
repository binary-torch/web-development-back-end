<?php
/*
    Connection class will handle the process of connecting to the
    database using PDO class that's provided in php.
*/
class Connection{
	/*
        ...
        refering back to static method and the $db parameter it just 
        a way of getting the parameter from an external file just 
